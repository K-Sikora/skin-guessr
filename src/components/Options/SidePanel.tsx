  ...
  return (
    <div className="w-20 md:w-32 flex flex-col items-center justify-start backdrop-blur-xl border-r-[1px] border-gray-300/30">
      ...
      <ul className="flex flex-col items-center mt-7 gap-10">
        <Link href="/play">
          <li className="flex hover:text-gray-500 duration-200 items-center justify-center w-10 h-10 md:w-14 md:h-14 rounded-full cursor-pointer">
        ...
        <li
          onClick={() => setOptionsVisible(false)}
          className="flex items-center justify-self-end justify-center w-6 md:w-8 h-6 md:h-8 rounded-full cursor-pointer hover:text-gray-500 duration-200"
        >
